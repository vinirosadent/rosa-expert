...
const PUBS = [
  ...
  { title: 'Guidance on biomaterials for periodontal tissue regeneration: Fabrication methods, materials and biological considerations', authors: 'Fischer N.G., de Souza Araújo I.J., Daghrery A., Yu B., Dal-Fabbro R., dos Reis-Prado A.H., Silikas N., Rosa V., Aparicio C., Watts D.C., Bottino M.C.', venue: 'Dental Materials', year: 2025, category: 'ai' },
  { title: 'Guidance on the assessment of the functionality of biomaterials for periodontal tissue regeneration: Methodologies and testing procedures', authors: 'Daghrery A., Dal-Fabbro R., dos Reis-Prado A.H., de Souza Araújo I.J., Fischer N.G., Rosa V., Silikas N., Aparicio C., Watts D.C., Bottino M.C.', venue: 'Dental Materials', year: 2025, category: 'ai' },
  { title: 'Graphene nanocoating on titanium maintains structural and antibiofilm properties post-sterilization', authors: 'Morin J.L.P., Dubey N., Luong-Van E.K., Yu B., Sabino C.F., Silikas N., Agarwalla S.V., Neto A.C., Rosa V.', venue: 'Dental Materials', year: 2025, category: 'bio' },
  { title: 'Comparing silver diamine fluoride delivery methods using microbrush, dental floss and Super Floss on a tooth-to-tooth interproximal contact model', authors: 'Kwek V.Y.X., Hong C.H.L., Rosa V., Lum J.L., Hong K., Hu S.', venue: 'Journal of Dentistry', year: 2025, category: 'bio' },

  /* ── 2024 ───────────────────────────────────────────────── */
  { title: 'Stearic acid nanoparticles increase acyclovir absorption by oral epithelial cells', authors: 'Rath P.P., Makkar H., Agarwalla S.V., Sriram G., Rosa V.', venue: 'Dental Materials', year: 2024, category: 'bio' },
  { title: 'The global burden of plastics in oral health: prospects for circularity, sustainable materials development and practice', authors: 'Ong A., Teo J.Y.Q., Watts D.C., Silikas N., Lim J.Y.C., Rosa V.', venue: 'RSC Sustainability', year: 2024, category: 'ai' },
  { title: 'Boron-containing coating yields enhanced antimicrobial and mechanical effects on translucent zirconia', authors: 'Sabino C.F., Agarwalla S.V., da Silva Rodrigues C., da Silva A.C., Campos T.M.B., Tan K.S., Rosa V., de Melo R.M.', venue: 'Dental Materials', year: 2024, category: 'bio' },
  { title: 'Development and characterization of nitazoxanide-loaded poly(epsilon-caprolactone) membrane for GTR/GBR applications', authors: 'Arora V., Lin R.Y.-T., Tang Y.L., Tan K.S., Rosa V., Sriram G., Dubey N.', venue: 'Dental Materials', year: 2024, category: 'regen' },
  { title: 'Physico-mechanical properties and bonding performance of graphene-added orthodontic adhesives', authors: 'Liu S., El-Angbawi A., Rosa V., Silikas N.', venue: 'Journal of Functional Biomaterials', year: 2024, category: 'bio' },
  { title: 'Optical effects of graphene addition on adhesives for orthodontic lingual retainers', authors: 'Liu S., El-Angbawi A., Ji R., Rosa V., Silikas N.', venue: 'European Journal of Oral Sciences', year: 2024, category: 'bio' },
  { title: 'Specimen shape and elution time affect the mineralization and differentiation potential of dental pulp stem cells to Biodentine', authors: 'Phang V., Malhotra R., Chen N.N., Min K.-S., Yu V.S.H., Rosa V., Dubey N.', venue: 'Journal of Functional Biomaterials', year: 2024, category: 'regen' },

  /* ── 2023 ───────────────────────────────────────────────── */
  { title: 'Graphene oxide increases PMMA resistance to fatigue and strength degradation', authors: 'Cahyanto A., Martins M.V.S., Bianchi O., Sudhakaran D.P., Sililkas N., Echeverrigaray S.G., Rosa V.', venue: 'Dental Materials', year: 2023, category: 'bio' },
  { title: 'Mesenchymal stromal cell exosomes enhance dental pulp cell functions and promote pulp-dentin regeneration', authors: 'Shi J., Teo K.Y.W., Zhang S., Lai R.C., Rosa V., Tong H.J., Duggal M.S., Lim S.K., Toh W.S.', venue: 'Biomaterials and Biosystems', year: 2023, category: 'regen' },
  { title: 'Biofabrication, biochemical profiling, and in vitro applications of salivary gland decellularized matrices via magnetic bioassembly platforms', authors: 'Ahmed K., Rodboon T., Oo Y., Phan T., Chaisuparat R., Yodmuang S., Rosa V., Ferreira J.N.', venue: 'Cell and Tissue Research', year: 2023, category: 'regen' },
  { title: 'Salivary gland regeneration from salivary gland stem cells to three-dimensional bioprinting', authors: 'Phan T.V., Oo Y., Ahmed K., Rodboon T., Rosa V., Yodmuang S., Ferreira J.N.', venue: 'SLAS Technology', year: 2023, category: 'regen' },
  { title: 'Identifying potential immuno-oncology targets in salivary gland mucoepidermoid carcinoma based on inflammatory status and treatment response', authors: 'Urumarudappa S.K.J., Tran V.N.T., Oo H.M., Suntiparpluacha M., Sampattavanich S., Rosa V., Ruangritchankul K., Ferreira J.N., Chaisuparat R.', venue: 'Journal of Oral Pathology and Medicine', year: 2023, category: 'regen' },
  { title: 'Effect of two graphene derivatives on Enterococcus faecalis biofilms and cytotoxicity', authors: 'Kim M.-A., Rosa V., Min K.-S.', venue: 'Dental Materials Journal', year: 2023, category: 'bio' },
  ...
  { title: 'Antimicrobial-free graphene nanocoating decreases fungal yeast-to-hyphal switching and maturation of cross-kingdom biofilms containing clinical and antibiotic-resistant bacteria', authors: 'Agarwalla S.V., Ellepola K., Sorokin V., Ihsan M., Silikas N., Neto A.C., Seneviratne C.J., Rosa V.', venue: 'Biomaterials and Biosystems', year: 2022, category: 'bio' },
  { title: 'Advanced scaffolds and strategies for dental pulp regeneration', authors: 'Soares D.G., Rosa V.', venue: 'Dental Clinics of North America', year: 2022, category: 'regen' },
  { title: 'Characterization of silver diamine fluoride cytotoxicity using microfluidic tooth-on-a-chip and gingival equivalents', authors: 'Hu S., Muniraj G., Mishra A., Hong K., Lum J.L., Hong C.H.L., Rosa V., Sriram G.', venue: 'Dental Materials', year: 2022, category: 'regen' },
  { title: 'Pandemic preparedness and response: a foldable tent to safely remove contaminated dental aerosols', authors: 'Rosa V., Agarwalla S.V., Tan B.L., Choo S.Y., Sim Y.F., Boey F.Y.C., Anantharaman S., Duggal M.S., Tan K.S.', venue: 'Applied Sciences', year: 2022, category: 'ai' },
  { title: 'RoBDEMAT: a risk of bias tool and guideline to support reporting of pre-clinical dental materials research and assessment of systematic reviews', authors: 'Delgado A.H., Sauro S., Lima A.F., Loguercio A.D., Della Bona A., Mazzoni A., Collares F.M., Staxrud F., Ferracane J., Tsoi J., Amato J., Neuhaus K.W., Ceballos L., Breschi L., Hanning M., Melo M.A., Özcan M., Scotti N., Opdam N., Yamaguchi S., Paris S., Turkun L.S., Doméjean S., Rosa V., Palin W., Schwendicke F.', venue: 'Journal of Dentistry', year: 2022, category: 'ai' },
  { title: 'SMART: silver diamine fluoride reduces microtensile bond strength of glass ionomer cement to sound and artificial caries-affected dentin', authors: 'Khor M.M.-Y., Rosa V., Sim C.J., Hong C.H.L., Hu S.', venue: 'Dental Materials Journal', year: 2022, category: 'bio' },
  ...
  { title: 'Fighting viruses with materials science and artificial intelligence', authors: 'Rosa V., Ho D., Sabino-Silva R., Siqueira W.L., Silikas N.', venue: 'Dental Materials', year: 2021, category: 'ai' },
  { title: 'Persistent inhibition of Candida albicans biofilm and hyphae growth on titanium by graphene nanocoating', authors: 'Agarwalla S.V., Ellepola K., Silikas N., Castro Neto A.H., Seneviratne C.J., Rosa V.', venue: 'Dental Materials', year: 2021, category: 'bio' },
  { title: 'Graphene nanocoating provides superb long-lasting corrosion protection to titanium alloy', authors: 'Malhotra R., Han Y., Nijhuis C.A., Silikas N., Castro Neto A.H., Rosa V.', venue: 'Dental Materials', year: 2021, category: 'bio' },
  { title: 'Pulsed electromagnetic fields synergize with graphene to enhance dental pulp stem cell-derived motor neurogenesis by targeting TRPC1 channel', authors: 'Madanagopal T.T., Tai Y.K., Lim S.H., Fong C.H.H., Cao T., Rosa V., Franco-Obregón A.', venue: 'European Cells and Materials', year: 2021, category: 'regen' },
  { title: 'Two-photon fluorescence microscopy and applications in angiogenesis and related molecular events', authors: 'Lee M., Kannan S., Muniraj G., Rosa V., Lu W.F., Fuh J.Y.H., Sriram G., Cao T.', venue: 'Tissue Engineering Part B: Reviews', year: 2021, category: 'ai' },
  { title: 'Characterization, antimicrobial effects, and cytocompatibility of a root canal sealer produced by pozzolan reaction between calcium hydroxide and silica', authors: 'Kim M.-A., Rosa V., Neelakantan P., Hwang Y.-C., Min K.-S.', venue: 'Materials', year: 2021, category: 'bio' },
  { title: 'Mechanical properties and in vitro cytocompatibility of dense and porous Ti-6Al-4V ELI manufactured by selective laser melting technology for biomedical applications', authors: 'Suresh S., Sun C.-N., Tekumalla S., Rosa V., Ling Nai S.M., Wong R.C.W.', venue: 'Journal of the Mechanical Behavior of Biomedical Materials', year: 2021, category: 'bio' },
  ...
  { title: 'Inhibiting corrosion of biomedical Ti-6Al-4V alloys with graphene nanocoating', authors: 'Malhotra R., Han Y.M., Morin J.L.P., Luong-Van E.K., Chew R.J.J., Castro Neto A.H., Nijhuis C.A., Rosa V.', venue: 'Journal of Dental Research', year: 2020, category: 'bio' },
  { title: 'Mechanisms of graphene influence on cell differentiation', authors: 'Luong-Van E.K., Madanagopal T.T., Rosa V.', venue: 'Materials Today Chemistry', year: 2020, category: 'bio' },
  { title: 'Biomechanics of alloplastic mandible reconstruction using biomaterials: The effect of implant design on stress concentration influences choice of material', authors: 'Prasadh S., Suresh S., Hong K.L., Bhargav A., Rosa V., Wong R.C.W.', venue: 'Journal of the Mechanical Behavior of Biomedical Materials', year: 2020, category: 'bio' },
  { title: 'Effect of a calcium hydroxide-based intracanal medicament containing N-2-methyl pyrrolidone as a vehicle against Enterococcus faecalis biofilm', authors: 'Kim T., Kim M.-A., Hwang Y.-C., Rosa V., Del Fabbro M., Min K.-S.', venue: 'Journal of Applied Oral Sciences', year: 2020, category: 'regen' },
  ...
  { title: 'Comparative study of different induction protocols for neural differentiation of human dental pulp stem cell in vitro', authors: 'Madanagopal T.T., Franco-Obregón A., Rosa V.', venue: 'Archives of Oral Biology', year: 2019, category: 'regen' },
  {
  ...
  { title: 'Bioactivity, physical and chemical properties of MTA mixed with propylene glycol', authors: 'Natu V.P., Dubey N., Loke G.C.L., Tan T.S., Ng W.H., Yong C.W., Cao T., Rosa V.', venue: 'Journal of Applied Oral Sciences', year: 2015, category: 'regen' },
  ...
  { title: 'Inducing pluripotency for disease modeling, drug development and craniofacial applications', authors: 'Rosa V., Toh W.S., Cao T., Shim W.', venue: 'Expert Opinion on Biological Therapy', year: 2014, category: 'regen' },
  ...
  { title: 'Dental pulp tissue engineering in full-length root canals', authors: 'Rosa V., Zhang Z., Grande R.H.M., Nör J.E.', venue: 'Journal of Dental Research', year: 2013, category: 'regen' },
  ...
  { title: 'Tissue engineering: from research to dental clinics', authors: 'Rosa V., Della Bona A., Cavalcanti B.N., Nör J.E.', venue: 'Dental Materials', year: 2012, category: 'regen' },
